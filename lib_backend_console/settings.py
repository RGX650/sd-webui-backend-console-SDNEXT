...
def create_settings_section():
    ...
    opts.add_option('backend_console_display_locations', OptionInfo(display_locations_default, 'Display the console at these locations', ui_components.DropdownMulti, {'choices': display_locations_choices}, section=section).needs_restart())
